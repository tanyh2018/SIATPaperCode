...
class Train(object):
    def __init__(self, XX_Net, gen_batch, BATCH_SIZE, Views, NumDet):
        ...
        self.train_writer = tf.summary.FileWriter('./logs/', tf.get_default_graph())
    ...
    def train(self, train_steps=1000000):
        ...
        # self.saver.restore(self.sess, save_path='./checkpoints/check_CT_taining_200')
        ...
        try:
            for steps in range(1, train_steps):
                ...
                if steps % 200 == 0:
                    save_path = self.saver.save(self.sess, "./checkpoints/check_CT_taining_2023_6_21_{}".format(str(steps)))
...
if __name__ == '__main__':
    ...
    train_root = Train(XX_Net, gen_batch, BATCH_SIZE, Views, NumDet)
    train_root.train()
