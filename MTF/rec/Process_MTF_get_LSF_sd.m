...
%% ===== Read in files =====
pixel_size = 24E-3; % pixel dimension, unit: mm
row = 200;
col = 200;
%%% catphan
...
c_row = 180; c_col =180; % # of rows and cols in the cropped image
max_cluster = 11;
c_pix = 50;
...
% Raw images
% filePath = 'D:/2022.7/Jiecheng/NanoCT/Simulation/ReconCT/add/yuhang/bone_without_zp/absor_final_';
...
% 
% fileName = {'period_1.30_sep_13.834_sample_self_DPCT'};
filePath = 'D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/data/split_test4/CTresult/'
...
dirOutput=dir(fullfile(filePath,'*_sd_*.raw'));      
