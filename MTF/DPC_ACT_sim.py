...
def paper_result():
    ...
    R=1.0     #mm
    print('sigma=',sigma*Pixel_size,'\nPixel size=',Pixel_size,'um')
    #pro_com_act()
    outfile = 'D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/data/split_test5/'
    #sd=[0.01,0.02,0.05,0.1,2.0,8.0,20,25.0,32.0,35.0,40.0]
    sdpc=[]
    sact=[]
    for i in range(1):
        splitdis = 120     #um
...
def draw_raw_dpc_act(dpc_raw,act_raw,size,N,outfile,splitdis,sigma,Pixel):
    gx = np.linspace(size[0],size[1],N)
    gx = rpn(gx,Pixel,N)
    fig1 = plt.figure(figsize=(9,6))
    plt.plot(gx,dpc_raw/np.max(dpc_raw),'red',label='DPC_Raw')
    plt.plot(gx,act_raw/np.max(act_raw),'blue',label='ACT_Raw')
    plt.xlabel( "Direction x [mm]",fontdict={'size': 24} )
    plt.ylabel("Normalization",fontdict={'size': 24} )
    ...
    with io.open(outfile_name_a,'wb') as f:
        for i in range(360):
            act_raw.astype(np.float32).tofile(f)
    outfile_name_a = outfile + 'period_8_sep_2.24_sigma_'+str(0.0)+'_phi_pixel_size_'+str(4800/Pixel)+'_m1'+'_sd_'+str(splitdis)+'.raw'
    with io.open(outfile_name_a,'wb') as f:
        for i in range(360):
            dpc_raw.astype(np.float32).tofile(f)
            
            
    act_raw=gauss_filter_reshape(act_raw,Pixel,sigma)
    ...
    dpc_raw=gauss_filter_reshape(dpc_raw,Pixel,sigma)
...
def phi1phi2_phase(gx,n,deltax,Pixel,R):
    ...
    k = 2*np.pi/(1.24/25.)/1e-3
    for j in range(n):
        f1[j]=func_circle_phase(gx[j],R,0.0)*delta*k*1e3
        f2[j]=func_circle_phase(gx[j],R,-deltax)*delta*k*1e3
        f3[j]=func_circle_phase(gx[j],R,deltax)*delta*k*1e3
        f4[j]=func_circle_phase(gx[j],R,-deltax*0.01)*delta*k*1e3
        f5[j]=func_circle_phase(gx[j],R,deltax*0.01)*delta*k*1e3
    ...
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DPC_pro.svg',bbox_inches='tight',pad_inches=0)
    ...
    # plt.axis('off')
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DPC_pro_L.svg',bbox_inches='tight',pad_inches=0)
    # # plt.plot(g2[:,1000])
    ...
    # plt.xlim(xmax=3.8,xmin=1)
    # plt.axis('off')
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DPC_pro_R.svg',bbox_inches='tight',pad_inches=0)
    # # plt.show()
    ...
    plt.savefig('DPC process.svg',bbox_inches='tight',pad_inches=0)
    #plt.legend(loc='best',fontsize=15,frameon=False)
    fig1 = plt.figure(figsize=(9,6))
    ...
    plt.xlabel( "x [mm]",fontdict={'size': 26} )
    plt.ylabel("Norm. Projection",fontdict={'size': 26} )
    plt.legend(loc='best',fontsize=26,frameon=False)
    plt.xlim(xmax=4.5,xmin=0.3)
    plt.ylim(ymax=2.0)
    plt.tick_params(labelsize=20)
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DPC_signal.svg',bbox_inches='tight',pad_inches=0)
    ...
    plt.ylim(ymax=2.0)
    plt.tick_params(labelsize=20)
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DPC_signal_sigma_1.55.svg',bbox_inches='tight',pad_inches=0)
    
    fig1 = plt.figure(figsize=(9,8))
    plt.plot(gx,pro_df/(max(pro_df)),'red',linestyle="--",label='$DF_1$',lw=1)
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DF_signal.svg',bbox_inches='tight',pad_inches=0)
...
def DF_plot(f1,f2,f3,n,gx):
    ...
    plt.xlim(xmax=3.8,xmin=1)
    plt.axis('off')
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DF_pro_L.svg',bbox_inches='tight',pad_inches=0)
    # plt.plot(g2[:,1000])
    ...
    plt.xlim(xmax=3.8,xmin=1)
    plt.axis('off')
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DF_pro_R.svg',bbox_inches='tight',pad_inches=0)
    ...
    plt.xlim(xmax=3.8,xmin=1)
    plt.axis('off')
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DF_pro_m.svg',bbox_inches='tight',pad_inches=0)
    ...
    plt.xlim(xmax=3.8,xmin=1)
    plt.axis('off')
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/DF_pro_total.svg',bbox_inches='tight',pad_inches=0)
...
def pro_com_act(size,N,outfile,splitdis,sigma,Pixel,R):
    ...
    outfile_name_d = outfile + 'period_8_sep_2.24_sigma_0.0_absor_pixel_size_'+str(4800/Pixel)+'_raw.raw'
...
def A1A2_absorption(gx,n,deltax,Pixel,R):
    ...
    # plt.tick_params(labelsize=18)
    # plt.axhline(1.2,color='#FCFC97',linestyle="-",lw=6)
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/ACT_pro.svg',bbox_inches='tight',pad_inches=0)
    # lines = g2[0,:]
    # fig1 = plt.figure(figsize=(9,6))
    # lines = lines.tolist()
    # #plt.axvline(lines.index(max(lines))/n*4.8,color='#9DC3E6',linestyle="-",lw=6)
    ...
    # plt.ylim(ymax=2.4)
    # plt.xlim(xmax=3.8,xmin=1)
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/ACT_pro_L.svg',bbox_inches='tight',pad_inches=0)
    # # plt.plot(g2[:,1000])
    ...
    # plt.xlim(xmax=3.8,xmin=1)
    # plt.axis('off')
    # plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/ACT_pro_R.svg',bbox_inches='tight',pad_inches=0)
    ...
    # plt.xticks([])
    # plt.yticks([])
    # plt.savefig('raw_pro.svg',bbox_inches='tight',pad_inches=0)
    #plt.show()
    fig1 = plt.figure(figsize=(9,6))
    ...
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/ACT_signal.svg',bbox_inches='tight',pad_inches=0)
    ...
    # ax.get_yaxis().get_offset_text().set(va='bottom', ha='left')
    # ax.yaxis.get_offset_text().set_fontsize(18)#设置1e6的大小与位置
    plt.savefig('D:/xianjinyuan/工作内容/Jiecheng/NanoCT/Simulation/NanoCT_Sim/SimCode/withoutZP/p1/ACT_signal_sigma_1.55.svg',bbox_inches='tight',pad_inches=0)
