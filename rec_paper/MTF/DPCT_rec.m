...
dirOutput=dir(fullfile(filePath,'period_8_sep_2.24_sigma_0.0_phi_pixel_size_12.0_m2_sd_204.0*.raw'));  
...
for ii = 1:length(filename)
    ...
    dx = single(25E-6);dy= dx;  %pixel size: dx*dy; Default Unit: m dy_det/dx=nx/px
