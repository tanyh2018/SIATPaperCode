...
%%-------------------分解三种物质（聚苯乙烯-二氧化硅-水）
path_name ='./python/';
file_name_I ='phase-tmp_image.raw';
...
scale = 0.15e-4*2;     %%重建图像单个像素大小，单位mm  512/360*0.4
det_size = 0.25e-4*2;   %%探测器单个像素大小，单位mm
...
out_file = "仿真聚苯乙烯-PMMA-水-"+model+"-fanbeamtomo-720-AI.raw";
